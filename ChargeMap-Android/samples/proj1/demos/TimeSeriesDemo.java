...
public class TimeSeriesDemo {
    public static void main(String[] args) {
        ...
        for (Number yearNumber : years) {
             ...
             * TimeSeries always require an integer key. Your output may be in
             * any order.
             */
         ...
         * zero error. TimeSeries<Double> quotient = ts.dividedBy(ts2);
         */
         ...
         * Number, and String is-not-a Number. TimeSeries<String> tsS = new
         * TimeSeries<String>();
         */
