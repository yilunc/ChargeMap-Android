...
public class YearlyRecordDemo {
    public static void main(String[] args) {
        ...
        /*
         * The code below should print: quayside appeared 95 times. merchantman
         * appeared 181 times. surrogate appeared 340 times.
         */
        ...
        /*
         * The code below should print the counts in ascending order: 95 181 340
         */
