...
public class WordNetDemo {
    public static void main(String[] args) {
        ...
        System.out.println("All nouns:");
        for (String noun : wn2.nouns()) {
            System.out.println(noun);
        }

        System.out.println("Hyponyms of event:");
        for (String noun : wn2.hyponyms("event")) {
            System.out.println(noun);
        }

        System.out.println("Hyponyms of conversion:");
        for (String noun : wn2.hyponyms("conversion")) {
            System.out.println(noun);
        }
    }
}
