...
public class YearlyRecordTimeTest {
    ...
    /**
     * Stright from: http://www.baeldung.com/java-random-string. Returns a
     * random string.
     */
    ...
    public void testRankCalls() {
        ...
        numWordsToPut = 1000;
        int numRankCallsEvenLarger = countRankCalls(numWordsToPut, maxTimeInSeconds);

        numWordsToPut = 10000;
        int numRankCallslargest = countRankCalls(numWordsToPut, maxTimeInSeconds);
